...
in
{
  programs.waybar.settings.mainBar = with custom; {
    ...
    cpu = {
      ...
      interval = 2;
      on-click-right = "hyprctl dispatch exec '[float; center; size 935 520] kitty --override font_size=10 --title float_kitty btop'";
    };
    memory = {
    ...
    network = {
      ...
      one-click = "hyprctl dispatch exec '[float; center; size 935 520] kitty --override font_size=10 --title float_kitty nmtui'";
    };
    tray = {
      icon-size = 20;
      spacing = 8;
